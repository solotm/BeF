...
public Plugin:myinfo =
{
	...
	description = "Add country of the player near his nick. Delete connect and disconnect message",
	version = VERSION,
	url = "http://www.a-l.fr/"
};
...
public OnPluginStart()
{
	...
	HookEvent( "player_info", Event_PlayerInfo, EventHookMode_Pre );
...
public OnClientPutInServer(client)
{
	...
	if(!IsFakeClient(client) && client != 0)
	{
		...
		{
			LogMessage("[Country Nick] User: %N ip: %s country: %s", client, ip, country);
		}
		else
		{
...
/*
Добавил это, чтобы нам не писало что мы ушли с сервака или выбрали тиму
 */
public Action:CD(Handle:event, const String:name[], bool:dontBroadcast)
{
    if (!dontBroadcast)
...
/*
Это вроде ваще не надо
 */
public Event_PlayerInfo( Handle:hEvent, const String:strEventName[], bool:bHidden )
{
